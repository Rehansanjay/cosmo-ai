...
// The yt-dlp helper (server/yt_dlp_server.mjs) runs beside the dev server;
// proxying it through Vite keeps the app same-origin, so <video> and fetch
// need no CORS handling.
const YT_HELPER = 'http://localhost:8793';
